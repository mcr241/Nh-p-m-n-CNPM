...
<body class="header-fixed">
	<div class="wrapper">
		...
		<div class="content container">
			<div class="row">
				<div class="col-md-12"">
					<span style="font-size: 50px; font-weight: bold;">Đăng kí</span>
				</div>
			</div>
			<div class="row">
			...
			<div class="container">
				<div class="row">
					<div class="col-md-7 md-margin-bottom-50">
						...
						<h2 class="welcome-title" style="font-weight: bold;">Hãy đăng
							kí để chúng tôi biết bạn!</h2>
					...
					<div class="col-md-5">
						<form id="sky-form4" class="log-reg-block sky-form"
							...
							<div class="login-input reg-input">
								...
								href="#">Chính sách bảo mật EleKet</a>
							</label>
						...
						<p class="text-center">
							Bạn đã có tài khoản? <a
								href="${pageContext.request.contextPath }/login"><strong>Đăng nhập</strong></a>
						</p>
					</div>
				</div>
				<!--/end row-->
