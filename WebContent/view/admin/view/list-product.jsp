...
<title>Eleket - Quản lý sản phẩm</title>
<!-- BOOTSTRAP STYLES-->
	...
	<div id="wrapper">
		...
		<div id="page-wrapper">
			<div id="page-inner">
				...
				<div
					style="color: white; padding: 15px 0px 5px 0px; font-size: 16px; margin-left: -60px">
					Welcome ${username } &nbsp; <a
						href="${pageContext.request.contextPath }/admin/product/add"
						class="btn btn-danger square-btn-adjust">Thêm sản phẩm</a>
				</div>
									...
									<table class="table table-striped table-bordered table-hover"
										...
										<thead>
											<tr>
												...
												<th style="text-align: center;">Giá (x1000 VND)</th>
